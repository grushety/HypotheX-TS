...
- [ ] Users can request and view model suggestions.
- [ ] Users can accept a suggested segmentation or edit over it without losing control.
- [ ] Accept and override actions are distinguishable in the audit log.
- [ ] The frontend uses the suggestion API rather than ad hoc mock logic.
- [ ] Tests cover at least one accept and one override flow.
...
### Required checks
- [ ] integration tests across backend/frontend boundary
- [ ] lint/static checks
- [ ] manual verification
