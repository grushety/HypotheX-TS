...
## Definition of Done
- [ ] Run `test-writer` agent — hatched rendering, gating rule, fill workflow, filled badge
- [ ] Run `code-reviewer` agent — no blocking issues
- [ ] `git commit -m "UI-017: gap indicator + missing-data gating for dense-data ops"`
