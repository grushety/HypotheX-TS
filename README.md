...
Score-based chunk scoring and default assignment now live in the same backend domain package and emit labels compatible with the shared `schemas/semantic-segmentation.schema.json` contract.
